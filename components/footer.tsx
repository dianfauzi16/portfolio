        ...
        <div className="grid md:grid-cols-3 gap-8 items-center">
          ...
          <div className="flex justify-center space-x-4">
            <Button
              ...
              onClick={() =>
                window.open("https://github.com/dianfauzi16", "_blank")
              }
            >
            ...
            <Button
              ...
              onClick={() =>
                window.open(
                  "https://linkedin.com/in/dian-fauzi-7bb8332ab",
                  "_blank",
                )
              }
            >
          ...
          <div className="text-center md:text-right">
            <p className="text-primary-foreground/80 text-sm">
              © {currentYear} M Dian Fauzi. All rights reserved.
            </p>
            <p className="text-primary-foreground/60 text-xs mt-1 flex items-center justify-center md:justify-end">
              Made with <Heart className="h-3 w-3 mx-1 text-red-400" /> using
              Next.js
            </p>
          </div>
        </div>
